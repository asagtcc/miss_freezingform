@extends('layout.app')
@section('title')
    Hessah Al-Mubarak | Membership Freezing
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            <div class="section-heading">
                <h2>MEMBERSHIP FREEZING <em>(HESSAH AL-MUBARAK)</em></h2>
                <p>ملاحظة
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <fieldset>
                                ...
                                <input type="text" class="form-control" placeholder="yyyy-mm-dd" name="date_from" value="{{ old('date_from') }}" id="date_from">
                                @error('date_from')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </fieldset>
                        ...
                        <div class="col-lg-12">
                            <fieldset>
                                ...
                                <input type="text" class="form-control" placeholder="yyyy-mm-dd" name="date_to" value="{{ old('date_to') }}" id="date_to" disabled>
