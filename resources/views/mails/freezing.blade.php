...
<head>
    ...
    <style type="text/css" id="hs-inline-css">
        ...
        .info_content span.title_info {
            font-weight: bold;
            color: #95a94f;
            margin: 0 10px 0 0;
        }

        .info_content span.info_val {
            color: #8A959E;
        }
    </style>
    ...
    <meta property="og:url" content="http://get.invisionapp.com/-temporary-slug-05dce8db-be97-44c8-9eb4-432de5c3cfa5">
    <meta name="x-apple-disable-message-reformatting">
</head>
<!--[if !((gte mso 9)|(IE))]><!-->

<body bgcolor="#eaeced" style="font-family:'Montserrat', sans-serif; color:#8a959e"><span class="preheader"
        summary="preheader"
        style="display:none !important; Margin-left:-9999 !important; width:0 !important; height:0 !important; visibility:hidden !important; min-width:0 !important; min-height:0 !important; font-size:0 !important; line-height:0 !important"
        width="0" height="0">Collegify</span>
    <!--<![endif]-->
    <table id="body" class="body" summary="body" width="100%" height="100%" align="center" border="0"
        cellspacing="0" cellpadding="0" style="background-color:#eaeced;">
        <tbody>
            <tr>
                            ...
                            <tr>
                                <td>
                                    <table class="inner-table" summary="inner-table" align="center" valign="top"
                                        ...
                                        style="width:93.75%; max-width:600px; Margin:0 auto; height:120px"
                                                ...
                                                <td align="center" valign="top">
                                                    <table class="master-table" width="600">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="responsive-table" width="570"
                                                                        border="0" cellpadding="0" cellspacing="0"
                                                                        valign="top">
                                                                        <tbody>
                                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top">
                                                                    <table class="responsive-table" width="580"
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr height="72" class="last-tr-height">
                                                                                <td>&nbsp;</td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
