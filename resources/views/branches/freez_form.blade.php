            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="contact-form">
                    <form id="contact" action="{{ route('form.store') }}" method="post" autocomplete="off"
                        ...
                        @csrf
                        <input type="hidden" name="branchid" value="{{ $branch?->id || 0 }}">
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset style="">
                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    ...
                                    <input type="text" class="form-control" placeholder="yyyy-mm-dd" name="date_from"
                                        value="{{ old('date_from') }}" id="date_from">
                                    @error('date_from')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </fieldset>
                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    <label>Freezing End Date / تاريخ نهاية الإيقاف </label>&nbsp;&nbsp;<label
                                        style="color: red;font-size: 12px;">(Note: Freezing start & end date must be in
                                        blocks of 7 days.)</label>
                                    <input type="text" class="form-control" placeholder="yyyy-mm-dd" name="date_to"
                                        value="{{ old('date_to') }}" id="date_to" disabled>
                                    <!-- <span style="color: red;font-size: 14px;padding-top: 0px;">Freezing start & end date must be in blocks of 7 days.</span> -->
                                    @error('date_to')
        ...
        $(function() {
            ...
            function updateCalendarDates() {
                ...
                if (startDateStr) {
                    ...
                    $("#date_to").val(formattedFirstAvailableDate);

                    // Calculate the other specific dates based on the first available date
                    var date2 = new Date(firstAvailableDate);
                    var date3 = new Date(firstAvailableDate);
                    var date4 = new Date(firstAvailableDate);
                    var date5 = new Date(firstAvailableDate);
                    var date6 = new Date(firstAvailableDate);
